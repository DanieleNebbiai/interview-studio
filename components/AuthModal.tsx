      ...
      <div className="bg-white rounded-2xl p-8 max-w-md w-full mx-4 relative">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            {isSignUp 
              ? 'Registrati per creare e gestire le tue interviste' 
        ...
        <div className="my-6 flex items-center">
          ...
          <div className="mx-4 text-gray-500 text-sm">o</div>
          <div className="flex-1 border-t border-gray-300"></div>
        </div>
        ...
        <Button
          ...
          disabled={loading}
          variant="outline"
          className="w-full border-gray-300 text-gray-700 font-medium py-3 px-6 rounded-lg transition-colors disabled:opacity-50"
        >
